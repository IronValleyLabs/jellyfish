...
export const IMPLEMENTED_SKILLS: AgentSkillDef[] = [
  ...
  { id: 'browser_visit', label: 'Browser Visit', description: 'Open URL in real browser (Puppeteer), optional login first', category: 'Research', icon: '🌐', implemented: true },
  { id: 'store_credential', label: 'Store credential', description: 'Save passwords/API keys from chat to .env (Lovable, Metricool, Instagram, etc.)', category: 'System', icon: '🔐', implemented: true },
  { id: 'write_file', label: 'Write file', description: 'Update docs/*.md or data/agent-knowledge.md so the agent learns', category: 'System', icon: '📝', implemented: true },
]
